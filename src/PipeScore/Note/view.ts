...
function noteHead(x: number, y: number, note: NoteModel, mousedown: (e: MouseEvent) => void, draggedNote: BaseNote | null, gracenoteBeingDragged: boolean, dispatch: Dispatch, opacity = 1): V {
