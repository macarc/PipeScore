...
export default new Map(Object.entries({
  ...
  'remove gracenote': 'Delete the gracenote from the currently selected note',
  'add bar before': 'Add a new bar before the currently selected bar, on the same stave',
  'add bar after': 'Add a new bar after the currently selected bar, on the same stave',
  ...
  'add lead in before': 'Add a lead in before the currently selected bar',
  'add lead in after': 'Add a lead in after the currently selected bar',
