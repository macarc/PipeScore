    ...
    return svg('g', { class: 'second-timing' }, [
      ...
      (start.y === middle.y)
        ...
        : svg('g', [
            ...
            svg('line', { x1: props.staveEndX, x2: props.staveEndX, y1: start.y - mid, y2: start.y - height, stroke: 'black' }),

            svg('line', { x1: props.staveStartX, x2: middle.beforeX, y1: middle.y - height, y2: middle.y - height, stroke: 'black' }),
            svg('line', { x1: props.staveStartX, x2: props.staveStartX, y1: middle.y - mid, y2: middle.y - height, stroke: 'black' }),

            ...[...Array(numberOfStavesBetweenStartAndMiddle).keys()].map(i => i + 1).map(i => svg('g', [
              svg('line', { x1: props.staveStartX, x2: props.staveEndX, y1: inBetweenStartAndMiddleY(i), y2: inBetweenStartAndMiddleY(i), stroke: 'black' }),
              svg('line', { x1: props.staveStartX, x2: props.staveStartX, y1: inBetweenStartAndMiddleY(i), y2: inBetweenStartAndMiddleY(i) + offset, stroke: 'black' }),
              svg('line', { x1: props.staveEndX, x2: props.staveEndX, y1: inBetweenStartAndMiddleY(i), y2: inBetweenStartAndMiddleY(i) + offset, stroke: 'black' }),
            ]))
          ]),
      (middle.y === end.y)
        ...
        : svg('g', [
            ...
            svg('line', { x1: props.staveEndX, x2: props.staveEndX, y1: middle.y - mid, y2: middle.y - height, stroke: 'black' }),

            svg('line', { x1: props.staveStartX, x2: end.afterX, y1: end.y - height, y2: end.y - height, stroke: 'black' }),
            svg('line', { x1: props.staveStartX, x2: props.staveStartX, y1: end.y - mid, y2: end.y - height, stroke: 'black' }),

            ...[...Array(numberOfStavesBetweenMiddleAndEnd).keys()].map(i => i + 1).map(i => svg('g', [
              svg('line', { x1: props.staveStartX, x2: props.staveEndX, y1: inBetweenMiddleAndEndY(i), y2: inBetweenMiddleAndEndY(i), stroke: 'black' }),
              svg('line', { x1: props.staveStartX, x2: props.staveStartX, y1: inBetweenMiddleAndEndY(i), y2: inBetweenMiddleAndEndY(i) + offset, stroke: 'black' }),
              svg('line', { x1: props.staveEndX, x2: props.staveEndX, y1: inBetweenMiddleAndEndY(i), y2: inBetweenMiddleAndEndY(i) + offset, stroke: 'black' })
            ]))
          ]),
