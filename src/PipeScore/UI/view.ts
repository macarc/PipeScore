  ...
  return h('div', [
    ...
    h('div', { id: 'sidebar', style: `width: ${state.width}px` }, [
      ...
      h('details', [
        ...
        h('button', { class: 'textual' }, { click: () => dispatch({ name: 'edit bar time signature' }) }, ['Edit Time Signature']),
        h('details', [
          h('summary', { class: 'inner' }, ['Repeat']),
          h('label', [
            'Start:',
            ...
            h('button', { class: 'textual' }, { click: () => dispatch({ name: 'set bar repeat', which: 'frontBarline', what: Barline.End }) }, ['Part']),
          ]),
          h('label', { style: 'display: block' }, [
            ...
            h('button', { class: 'textual' }, { click: () => dispatch({ name: 'set bar repeat', which: 'backBarline', what: Barline.End }) }, ['Part']),
          ]),
        ]),
        h('details', [
          h('summary', { class: 'inner' }, ['Lead In']),
      ...
      h('details', [
        ...
        h('button', { class: 'double-width text' }, { click: () => dispatch({ name: 'centre text' }) }, [ 'Centre text' ]),
      ]),
      h('details', [
