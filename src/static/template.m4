...
define(`STYLED_PAGE', `RAW_PAGE($1, `<link type="text/css" rel="stylesheet" href="styles/$2.css" />', `', $3)')dnl
define(`JS_PAGE', `RAW_PAGE($1, `', `<script src="$2"></script>', $3)')dnl
define(`STYLED_JS_PAGE', `RAW_PAGE($1, `<link type="text/css" rel="stylesheet" href="styles/$2.css" />', `<script src="$3"></script>', $4)')dnl
