...
describe("correctly parses score body", () => {
    ...
    test("it can skip unknown tokens", () => {
        const ast: Score = parser.parse(
            `Bagpipe Reader:1.0
                ...
                "100 Years and More",(T,L,0,0,Times New Roman,14,700,0,0,18,0,0,0)
                "March",(Y,R,0,0,Times New Roman,14,400,0,0,18,0,0,0)
                TuneTempo,84
                "MacLeod, Elizabeth -
                "Line  1 ---",(F,R,0,0,Times New Roman,12,400,0,0,18,0,0,0)
                ,0,0,Times New Roman,14,400,0,0,18,0,0,0)
                "Line  1 ---" 
                & sharpf sharpc sharpf sharpc 4_4 `
        );
